...
document.getElementById("myselect").onchange = function (evt) {
    window.value = evt.target.value;
};

var itemcount = (JSON.parse(localStorage.getItem('ItemCount')));
if (itemcount == null) {
    itemcount = {};
}
                ...
                .then(data => {
                    ...
                    <div class = "meal-item" data-id = "${meal.idMeal}">
                        ...
                        <div class = "meal-name">
                            ...
                            <span class="heart " id="${meal.idMeal}" onclick="like(${meal.idMeal})">${loadLike(meal.idMeal)} </span>
